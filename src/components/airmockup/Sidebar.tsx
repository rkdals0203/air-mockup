...
const Sidebar = ({
  ...
  return (
    <motion.aside
      ...
      className="w-80 min-w-[320px] h-screen flex flex-col border-r border-border bg-card overflow-hidden"
    >
      ...
      <div className="flex-1 min-h-0 p-6 space-y-4 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
